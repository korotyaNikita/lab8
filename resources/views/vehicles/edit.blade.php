    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Редагування транспортного засобу</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Редагування транспортного засобу</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <form method="post" action="{{ route('vehicles.update', $vehicle->id) }}" class="w-50">
                            @method('PATCH')
                            @csrf
                                ...
                                <select name="license_plate" class="custom-select">
                                    @foreach($licensePlates as $licensePlate)
                                        <option value="{{ $licensePlate->id }}"
                                            {{ $licensePlate->id == old('license_plate', $vehicle->license_plate) ? ' selected' : '' }}
                                        >
